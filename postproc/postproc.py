...
#
    ...
    jobname  = {
                ...
                '5':'singleHydrogenDiffusionExtendedDislocation',#'multiHydrogenDiffusionLong',#'singleHydrogenDiffusionLong', 
                }['5']
    DeleteExistingFolder = True
    readPath = os.getcwd() + {
                                '3':'/../simulations/NiNatom16KTemp1400K',
                                '4':'/../simulations/CantorNatom16KTemp1000KEnsemble8',
                                '5':'/../simulations/singleHydrogenDiffusionExtendedDislocation',
                            }['5'] #--- source
