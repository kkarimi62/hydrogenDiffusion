...
if __name__ == '__main__':
		...
		def SetVariables():
			Variable = {
					...
					7:' -var buff 0.0 -var T 900.0 -var P 0.0 -var nevery 100 -var ParseData 1 -var DataFile data_minimized.txt -var DumpFile dumpThermalized.xyz -var WriteData Equilibrated_300.dat',
