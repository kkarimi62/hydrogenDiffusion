...
if __name__ == '__main__':
    ...
    def SetVariables():
        Variable = {
                ...
                72:' -var buff 0.0 -var buffy 0.0 -var Tinit 0.1 -var T 2000.0 -var seed %s -var nevery 100 -var ParseData 1 -var DataFile data_minimized.txt -var DumpFile dumpThermalized.xyz -var WriteData Equilibrated.dat'%np.random.randint(1001,9999),
