...
#		EXEC_DIR = '/home/kamran.karimi1/Project/opt/deepmd-kit/bin' #--- path for executable file: deep potential
		...
		def SetVariables():
			Variable = {
					...
					51:' -var buff 0.0 -var nevery 1000 -var ParseData 1 -var DataFile data_init.txt -var DumpFile dumpMin.xyz -var WriteData data_minimized.txt', 
		...
		indices = {
					...
					8:['p2','p6',51,'p7','p3','p5',1.0], #--- dislocate, add H, minimize, kart input, kart.sh to bash shell ,invoke kart
