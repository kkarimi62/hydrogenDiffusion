...
if __name__ == '__main__':
    ...
    jobname  = {
                ...
                4:'mitStuff2nd', 
                5:'test3rd', #'multiHydrogenDislocated/rho/rho3', #'multiHydrogenDiffusionLong/rho/rho0',
    ...
    def SetVariables():
        Variable = {
                ...
                'p2':' %s 3.54 25.0 16.0 3.0  data_minimized.txt 4 2 1.0 0.0'%(os.getcwd()+'/lmpScripts'),
