...
setenv TOPO_RADIUS                    2.7 #3.5 #4.0     # radius for topology cluster > CRYST_TOPO_RADIUS 
setenv MAX_TOPO_CUTOFF                2.0 #3.0     # length-cutoff used by default to link two atoms
setenv MIN_TOPO_CUTOFF                1.0 #2.2     # minimal length cutoff used when looking at secondary topologies 
...
setenv CRYST_TOPO_RADIUS              2.0 #3.0     # radius for crystal-like topologies (default: 4.0 A) 
