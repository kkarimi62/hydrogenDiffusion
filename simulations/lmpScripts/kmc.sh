...
setenv NBRE_KMC_STEPS                10 #00       # The max number of KMC steps to be executed
...
setenv TOPO_RADIUS                    3.5 #4.0     # radius for topology cluster > CRYST_TOPO_RADIUS 
...
#setenv CRYST_TOPOID                   59667		# topo id of the crystalline-like topologies
#setenv CRYST_TOPOID                   1037429	# topo id of the crystalline-like topologies
#setenv CRYST_TOPOID                   352084	# topo id of the crystalline-like topologies
#setenv CRYST_TOPOID                   303929	# topo id of the crystalline-like topologies
...
setenv EVENT_REMOVE_FILE 			  'Event_remove' # File where events ids to remove from catalogue are stored #(applied at start of sim) (default: Event_remove)
...
setenv ALLCONF_WITH_SADDLE           .false. #.true.
setenv PRINT_DETAILS                 .false. #.true.  # Prints the details of activation and minimization 
setenv MINSAD_DETAILS                .false.  # Prints the details of activation and minimization 
setenv USE_TXT_EVENTFILE             .false. #.true.
setenv STATISTICS                    .false. #.true.   # Write statistics about force and event calculation  
setenv OUTPUT_CONFIG_EVENTS          .false. #.true.   # IF true, will create a txt file with the list of all the topologies and events after each KMC step
setenv OUTPUT_SPECIFIC   	     .false. #.true.
